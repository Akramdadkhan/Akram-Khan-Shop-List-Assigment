...
const MumbaiSuburbanShop = () => {
    ...
    const finalResult=useSelector((state)=>state.MumbaiSuburbanShopReducer.ShopData)
    useEffect(()=>{
    ...
    return (
        ...
        <div style={{float:"right"}} >
            <h1 style={{ marginTop:"15px",textAlign:"centre"}}>SHOPS IN MUMBAI SUBURBAN</h1>
                {shopData.map((item) => {
        return (
...
export default MumbaiSuburbanShop;